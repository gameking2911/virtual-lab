...
function cc4011:loadConnection ( experiment,main_socket,sub_socket )
	...
	experiment.sl_tree:creatConnection( 5,experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[3])].IDtable,
	...
	experiment.sl_tree:creatConnection( 5,experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[4])].IDtable,
	...
	experiment.sl_tree:creatConnection( 5,experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[10])].IDtable,
	...
	experiment.sl_tree:creatConnection( 5,experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[11])].IDtable,
...
function cc4011:deleteConnection ( experiment,main_socket,sub_socket )
	...
	for i=1,self.portsnum do
		...
		if experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[i])] then
			experiment.sl_tree:destroyConnection( 5,experiment.outputIndex[tmsh][tmsh:getSubMesh(sub_socket[i])].IDtable )
		end
	end
end
